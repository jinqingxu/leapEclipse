...
public class LeapListener extends Listener{
	...
	public String[] readOffsetXYZ() {
		...
		String readCSV = LeapPrecision.writeLeapPath+LeapPrecision.fileName;
        ...
        while(reader.readRecord()){ 
         ...
         String[] result=new String[4]; // the result to be written in the file
         result[0]=dateTime;
	...
	public void writeOffsetXYZ(String[] result) {
        ...
        String targetFile = LeapPrecision.writePath+fileName;
        ...
        if (!(file.exists())) {//new file
        	  ...
        	  file.createNewFile();
        	  String[] header = {"DateTime","AverageX(mm)","AverageY(mm)","AverageZ(mm)"};                    
	...
	public void  onExit(Controller controller){
		...
		if(Double.parseDouble(LeapPrecision.pid)>8000) {
	...
	public void onFrame(Controller controller){
		...
		try {
        	...
        	FileOutputStream outPath = new FileOutputStream(new File(LeapPrecision.writeLeapPath + LeapPrecision.fileName),true);			
